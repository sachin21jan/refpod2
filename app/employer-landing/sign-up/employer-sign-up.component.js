...
var EmployerSignUpComponent = (function () {
    function EmployerSignUpComponent(_formBuilder, _authenticationService, _router) {
    ...
    EmployerSignUpComponent.prototype.ngOnInit = function () { };
    EmployerSignUpComponent.prototype.login = function () {
    ...
    EmployerSignUpComponent = __decorate([
        core_1.Component({
    ...
    return EmployerSignUpComponent;
}());
exports.EmployerSignUpComponent = EmployerSignUpComponent;
//# sourceMappingURL=employer-sign-up.component.js.map